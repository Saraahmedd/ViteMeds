  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light w-100">
      <div className="container d-flex flex-row justify-content-between w-100">
        ...
        <div
          className={`links&buttons collapse navbar-collapse col-md-6 align-self-end ${
            isMenuOpen ? "show" : ""
          }`}
        >
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/admin/pharmacists">
                Pharmacists
              </a>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/admin/medicines">
                Medicines
              </a>
            </li>
            <li className="nav-item">
              <a
                ...
                className="btn btn-primary ms-2 mx-1"
                href="/guest/login"
              >
                Logout
              </a>
