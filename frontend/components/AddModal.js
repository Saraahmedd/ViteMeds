...
function AddModal(props) {
  ...
  const handleAddMedicine = () => {
    ...
    if (edit) dispatch(editMedicine(medicine?._id, combinedFormData));
    else dispatch(addMedicine(combinedFormData));
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        {!edit && (
          <Modal.Title id="contained-modal-title-vcenter">
            <h3 className="text-bold text-center text-global">Add Medicine</h3>
          </Modal.Title>
        )}
        {edit && (
          <Modal.Title id="contained-modal-title-vcenter">
            <h3 className="text-bold text-center text-global">Edit Medicine</h3>
          </Modal.Title>
        )}
        <hr />
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="col-md-4 mb-2 mxx-auto">
            <label
              htmlFor="document1"
              className="d-flex align-items-center justify-content-between form-label text-semibold"
            >
              Image
      ...
      <Button
        text={edit ? "Edit" : "Add"}
        className="desc-button col-md-4 mx-auto my-3"
        size="md"
