  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light w-100">
      <div className="container d-flex flex-row justify-content-between align-items-center w-100">
        ...
        <div
          className={`links&buttons collapse navbar-collapse col-md-6 ${
            isMenuOpen ? "show" : ""
          }`}
        >
          <ul className="navbar-nav container d-flex justify-content-end me-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/guest/registerPharmacist">
                Careers
              </a>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item ">
              <a
                className="btn btn-light text-primary ms-3 mx-1"
                href="/guest/login"
              >
                Login
              </a>
