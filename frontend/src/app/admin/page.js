            ...
            <div className="col-md-4">
              <div className="card shadow bg-light border-0 mb-4">
                <div className="card-body">
                  <h5 className="card-title text-primary text-bold">
                    Account Information
                  </h5>
                  <hr />
                    ...
                    <div className="card-body">
                      ...
                      <ul className="list-group border-0 mx-2">
                        {patientReports.map((report, index) => (
                          <li
                            key={index}
                            className={`list-group-item rounded shadow mb-3}`}
                          >
                ...
                <div className="card-body">
                  ...
                  <div className="text-semibold text-primary row container justify-content-center">
                    <Button
                      className="col-md-3"
                      variant="md"
                      onClick={(e) => handleStatPeriod(e, "This Week")}
                      text={"This Week"}
                      color={statPeriod == "This Week" ? "" : "dark"}
                    ></Button>
                    <Button
                      className="col-md-3"
                      variant="md"
                      onClick={(e) => handleStatPeriod(e, "This Month")}
                      text={"This Month"}
                      color={statPeriod == "This Month" ? "" : "dark"}
                    ></Button>
                    <Button
                      className="col-md-3"
                      variant="md"
                      onClick={(e) => handleStatPeriod(e, "This Year")}
                      text={"This Year"}
                      color={statPeriod == "This Year" ? "" : "dark"}
                    ></Button>
                  </div>
                  <div className="row p-2 m-2 border bg-white rounded">
                    <div className="col-md-4 d-flex ">
                      <div className="leftline-Bold bg-primary me-2"></div>
                      <div className=" text-dark text-semibold">
                        {statData[statDataIdx].patients} New Patients
                      </div>
                    </div>
                    <div className="col-md-4 d-flex ">
                      <div className="leftline-Bold bg-primary me-2"></div>
                      <div className=" text-dark text-semibold">
                        {statData[statDataIdx].doctors} New Doctors
                      </div>
                    </div>
                    <div className="col-md-4 d-flex ">
                      <div className="leftline-Bold bg-primary me-2"></div>
                      <div className=" text-dark text-semibold">
                        {statData[statDataIdx].appointments} Appointments
                      </div>
                    </div>
                  </div>
                  <br />
                  <div className="geo-section">
                    <h5 className="px-2 text-semibold text-dark pt-2">
                        ...
                        <table className="table">
                          <thead>
                            <tr>
                              ...
                              <th className="text-muted border-left">
                                Patients
                              </th>
                              <th className="text-muted border-left">
                                Appointments
                          ...
                          <tfoot>
                            <tr>
                              ...
                              <td className="text-semibold text-primary bg-light">
                                Total Successful Appointments
                              </td>
                              <td className="bg-light"></td>
                              <td className="text-semibold text-primary bg-light">
                                {statData[statDataIdx].appointments}
                              </td>
                            </tr>
                          </tfoot>
                        </table>
