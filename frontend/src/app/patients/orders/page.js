          ...
          {patient ? (
            <div className="container mt-4">
              ...
              <Modal
                ...
                onHide={() => handleCancelConfirmation(false)}
              >
              ...
              <Modal show={showModal2} onHide={handleCloseModal2}>
                ...
                <Modal.Body>
                  ...
                  {selectedOrder && (
                    <>
                      <p>
                        <h6>Status:</h6> {selectedOrder.status}
                      </p>
                      <p>
                        <h6>Payment Method:</h6> {selectedOrder.paymentMethod}
                      </p>
                      <p>
                        <h6>Total Price:</h6> {selectedOrder.totalPrice}$
                      </p>
                      <p>
                        <h6>Created At:</h6> <p></p>
