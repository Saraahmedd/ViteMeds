...
function Checkout() {
    ...
    const patientLoading = useSelector((state) => state.viewMyDetailsReducer.loading);
                    ...
                    <div className="border-r-2 border-gray-800 h-full w-full p-5">
                        ...
                        {addNewAddress &&
                            <div className="w-full mt-3">
                                ...
                                <TextInput
                                    ...
                                    id="address" className="mt-2" placeholder="Example: 14 Omar St." />
                                ...
                                <div className="mt-3">
                                    ...
                                    <Select id="gov"
                                        ...
                                        value={address.city} className="mt-2">
                                ...
                                <div className="mt-3 flex flex-row gap-x-2">
                                    <div className="flex-1">
                                        ...
                                        <TextInput
                                            ...
                                            id="district" className="mt-2" placeholder="Example: Smouha" />
                                    </div>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        }} id="zip" className="mt-2" placeholder="Example: 21646" />
                                    </div>
                                </div>
                        ...
                        {!addNewAddress &&
                            <div className="mt-3 flex flex-col">
                                ...
                                <Select value={address} onValueChange={setAddress} placeholder="Select an Address.." className="mt-2" id="myAddresses">
                                    {
                                        patient && patient.deliveryAddress.map(
                                            (address, index) => {

                                                return (
                                                    <SelectItem value={address} key={`dlv${index}`}>{address.streetAddress}, {address.city}, {address.state} {address.zipCode}, {address.country}</SelectItem>
                                                )
                                            }
                                        )
                                    }
                                </Select>
                                <div role="button" onClick={() => { setAddress({}); setAddNewAddress(true) }} className="flex-row flex items-center ms-auto mt-1">
                        ...
                        <div className="mt-3">
                            ...
                            <div className="rounded-lg border border-gray-800 mt-2 overflow-hidden">
                                ...
                                <div onClick={() => setPaymentMethod("Stripe")} role="button" className={`${paymentMethod === 'Stripe' ? 'bg-blue-950' : 'bg-gray-900'} border-gray-800 border-t-2 h-[4rem] p-2 flex items-center`}>
                                    Card
                                </div>
                                <div onClick={() => {
                    ...
                    <div className="border-l-1 border-gray-800 h-full w-full p-5">
                        ...
                        <div className="rounded-lg border border-gray-800 mt-2 overflow-hidden">
                                ...
                                cart && cart.items.map((item, index) => (
                                    <div className={`${index !== 0 ? 'border-t-2' : ''} bg-gray-900 h-[8rem] px-6 py-2 flex flex-row items-center border-gray-800`}>
                                        ...
                                        <div className="ml-6">
                                            ...
                                            <h1 className="font-semibold text-sm">{item.quantity} x {item.currentPrice} USD</h1>
                                        </div>
                                        <div className="flex-1 grow justify-end">
                                            <p className="text-end font-bold">{item.currentPrice} USD</p>
                                        </div>
                                    </div>
                                ))
                            }
                            ...
                            <div className={`bg-gray-900 px-6 py-2 flex flex-row items-center border-t-2 border-gray-800`}>
                                ...
                                <p className="ml-auto font-bold">{cart && cart?.totalPrice} USD</p>
                            </div>
