"use client"
import CarCard from "@/components/CarLicense";
...
export default function Licenses() {
    ...
    const reloadLicenses = async () => {
        fetch(`/api/staff/pendingcars`).then(async res => {
    ...
    return (
        <>
            <Card className="grow flex-1 flex flex-col items-center justify-center">
                <GradientText wclass={'text-4xl text-center'} text="Car License Approvals" />
                {licenses &&
                    <>
