            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-row items-center self-end lg:self-center">
                        <div role="button" onClick={() => setQuantity(q => q - 1 > 0 ? q - 1 : 1)} className="flex items-center justify-center p-5 text-2xl rounded-md border h-3 w-3 mx-3 hover:bg-white hover:text-black">
                            -
                        </div>

                        <span className="font-bold">{quantity}</span>

                        <div onClick={() => setQuantity(q => q + 1)} role="button" className="flex items-center justify-center p-5 text-2xl rounded-md border h-3 w-3 mx-3 hover:bg-white hover:text-black">
                            +
                        </div>
                    </div>
